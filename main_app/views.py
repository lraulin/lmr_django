...
from main_app.forms import CategoryForm, PageForm, UserForm, UserProfileForm
from main_app.models import Category, Page, UserProfile
from main_app.webhose_search import run_query
...
def about(request):
    ...
    # Cookie test over
    response = render(request, 'main_app/about.html')
    # Call the helper function to handle the cookies
    visitor_cookie_handler(request)
...
def show_category(request, category_name_slug):
    ...
    return render(request, 'main_app/category.html', context_dict)
...
def add_category(request):
    ...
    return render(request, 'main_app/add_category.html', {'form': form})
...
def add_page(request, category_name_slug):
    ...
    return render(request, 'main_app/add_page.html', context_dict)
...
def register_profile(request):
    ...
    return render(request, 'main_app/profile_registration.html', context_dict)
...
def profile(request, username):
    ...
    return render(request, 'main_app/profile.html', {'userprofile': userprofile,
                                                  'selecteduser': user,
                                                  'form': form})
...
def list_profiles(request):
    ...
    return render(request, 'main_app/list_profiles.html', {'userprofile_list': userprofile_list})
...
def suggest_category(request):
    ...
    return render(request, 'main_app/cats.html', {'cats': cat_list})
...
def auto_add_page(request):
    ...
    if request.method == 'GET':
        ...
        if cat_id:
            ...
            context_dict['pages'] = pages
    return render(request, 'main_app/page_list.html', context_dict)
